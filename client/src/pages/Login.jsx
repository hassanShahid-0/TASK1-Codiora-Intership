...
const Login = () => {
  ...
  return (
    <div className="container d-flex align-items-center justify-content-center min-vh-100 py-5">
      <div className="card shadow-lg border-0 rounded-3 overflow-hidden" style={{ maxWidth: '440px', width: '100%' }}>
        <div className="card-body p-5 bg-white">
          <div className="text-center mb-4">
            <span className="fs-1">🌱</span>
            <h2 className="fw-bold text-dark mt-2">Welcome to GrowthHub</h2>
            <p className="text-muted">Sign in to manage your professional growth space</p>
          </div>
